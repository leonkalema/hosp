...
//Function
function showStayDuration(accountbalanceid, startdate, noofdays, roomtypeid, location)
{
	accountbalanceid = $("#"+accountbalanceid).val();
	...
	$.post("../includes/showreservation.php",
	{ accountbalanceid: accountbalanceid, startdate: startdate, noofdays: noofdays, roomtypeid: roomtypeid },
		function(data){
