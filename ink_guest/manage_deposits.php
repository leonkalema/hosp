<?php
	...
	if($_GET['d'])
	{
		...
		$url = "../ink_guest/manage_deposits.php".$path;
	...
	if($_GET['s'])
	{
		...
		mysql_query("UPDATE tbl_payments SET senddeposit = 1 WHERE id = '".$id."'");
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <title>Hotel Catherine - Manage Deposits</title>
