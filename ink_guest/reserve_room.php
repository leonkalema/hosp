...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link type="text/css" href="../ink_css/theme/base/ui.all.css" rel="stylesheet" />
        <script type="text/javascript" language="javascript" src="../ink_js/jquery.js">
        </script>
        <script type="text/javascript" language="javascript" src="../ink_js/sitej_guest.js">
        </script>
        <script type="text/javascript" language="javascript" src="../ink_js/ui/ui.core.js">
        </script>
    	<script type="text/javascript" language="javascript" src="../ink_js/ui/ui.datepicker.js">
        </script>
        <script type="text/javascript">
    
			$(function() {
	
			$("#startdate").datepicker({minDate: -0, maxDate: '+12M'});
    ...
    <body>
        <table border="0" width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td align="center">
                    <?php require_once("../includes/middle_section_guest.php"); ?>
                </td>
            </tr>
            <tr>
