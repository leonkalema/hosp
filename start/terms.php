<?php
	...
	$homepage = mysql_fetch_array(mysql_query("SELECT content FROM tbl_website WHERE location = 'terms_and_conditions'"));
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <title>Hotel Catherine - Terms and Conditions</title>
